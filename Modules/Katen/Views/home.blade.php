    ...
    <div class="row gy-4">
        <div class="col-lg-8">
            ...
            <div class="ads-horizontal text-md-center">
                ...
                <a href="#">
                    <img src="{{ asset('katenTheme/images/ads/ad-750.png') }}" alt="Advertisement" />
                </a>
            </div>
            ...
            <div class="section-header">
                ...
                <img src="{{ asset('katenTheme/images/wave.svg') }}" class="wave" alt="wave" />
            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="post">
                            <div class="thumb rounded">
                                ...
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/trending-lg-1.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                            <ul class="meta list-inline mt-4 mb-0">
                                <li class="list-inline-item"><a href="#"><img
                                            src="{{ asset('katenTheme/images/other/author-sm.png') }}" class="author"
                        ...
                        <div class="post post-list-sm square before-seperator">
                            <div class="thumb rounded">
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/trending-sm-1.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="post post-list-sm square before-seperator">
                            <div class="thumb rounded">
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/trending-sm-2.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="post">
                            <div class="thumb rounded">
                                ...
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/trending-lg-2.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="post post-list-sm square before-seperator">
                            <div class="thumb rounded">
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/trending-sm-3.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="post post-list-sm square before-seperator">
                            <div class="thumb rounded">
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/trending-sm-4.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
            ...
            <div class="row post-carousel-twoCol post-carousel">
                ...
                <div class="post post-over-content col-md-6">
                    ...
                    <a href="blog-single.html">
                        <div class="thumb rounded">
                            <div class="inner">
                                <img src="{{ asset('katenTheme/images/posts/inspiration-1.jpg') }}" alt="thumb" />
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="post post-over-content col-md-6">
                    ...
                    <a href="blog-single.html">
                        <div class="thumb rounded">
                            <div class="inner">
                                <img src="{{ asset('katenTheme/images/posts/inspiration-2.jpg') }}" alt="thumb" />
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="post post-over-content col-md-6">
                    ...
                    <a href="blog-single.html">
                        <div class="thumb rounded">
                            <div class="inner">
                                <img src="{{ asset('katenTheme/images/posts/inspiration-3.jpg') }}" alt="thumb" />
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="col-md-12 col-sm-6">
                        ...
                        <div class="post post-list clearfix">
                            <div class="thumb rounded">
                                ...
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/latest-sm-1.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-md-12 col-sm-6">
                        ...
                        <div class="post post-list clearfix">
                            <div class="thumb rounded">
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/latest-sm-2.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-md-12 col-sm-6">
                        ...
                        <div class="post post-list clearfix">
                            <div class="thumb rounded">
                                ...
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/latest-sm-3.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-md-12 col-sm-6">
                        ...
                        <div class="post post-list clearfix">
                            <div class="thumb rounded">
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/latest-sm-4.jpg') }}"
                                            alt="post-title" />
                                    </div>
                                </a>
                            </div>
            ...
            <div class="sidebar">
                ...
                <div class="widget rounded">
                    <div class="widget-about data-bg-image text-center"
                        data-bg-image="{{ asset('katenTheme/images/map-bg.png') }}">
                        <img src="{{ asset('katenTheme/images/logo.svg') }}" alt="logo" class="mb-4" />
                    ...
                    <div class="widget-content">
                        ...
                        <div class="post post-list-sm circle">
                            <div class="thumb circle">
                                ...
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/tabs-2.jpg') }}" alt="post-title" />
                                    </div>
                                </a>
                            </div>
                            <div class="details clearfix">
                        ...
                        <div class="post post-list-sm circle">
                            <div class="thumb circle">
                                ...
                                <a href="blog-single.html">
                                    <div class="inner">
                                        <img src="{{ asset('katenTheme/images/posts/tabs-3.jpg') }}" alt="post-title" />
                                    </div>
                                </a>
                            </div>
                            <div class="details clearfix">
                        ...
                        <div class="post-carousel-widget">
                            ...
                            <div class="post post-carousel">
                                <div class="thumb rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('katenTheme/images/widgets/widget-carousel-1.jpg') }}"
                                                alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="post post-carousel">
                                <div class="thumb rounded">
                                    ...
                                    <a href="blog-single.html">
                                        <div class="inner">
                                            <img src="{{ asset('katenTheme/images/widgets/widget-carousel-2.jpg') }}"
                                                alt="post-title" />
                                        </div>
                                    </a>
                                </div>
                ...
                <div class="widget no-container rounded text-md-center">
                    ...
                    <a href="#" class="widget-ads">
                        <img src="{{ asset('katenTheme/images/ads/ad-360.png') }}" alt="Advertisement" />
                    </a>
                </div>
